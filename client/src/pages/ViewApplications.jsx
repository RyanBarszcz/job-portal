...
const ViewApplications = () => {
    ...
    // Function to fetch Job Applications data
                    ...
                    <tbody>
                        {applicants.filter(item => item.jobId && item.userId).map((applicant, index) => (
                            <tr key={index} className='text-gray-700'>
                                ...
                                <td className='py-2 px-4 border-b max-sm:hidden border-gray-200'>{applicant.jobId.title}</td>
                                <td className='py-2 px-4 border-b max-sm:hidden border-gray-200'>{applicant.jobId.location}</td>
